...
<header>
	<div class="header-light">
		...
		<div class="header-logo">
			<div class="container">
				<div class="pull-left">
					<a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr(get_bloginfo('description')); ?>" class="logo widget-logo">
				...
				<div class="banner-adv-728x90 pull-right">
					<?php echo wp_kses_post($content_beside_logo); ?>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
