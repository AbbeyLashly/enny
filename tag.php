...
$top_atts= array( "layout" => "block-slider-01", "limit_post" => $limit, "tag_list" => urlencode("[{\"tag_slug\":\"" . $terms->slug . "\"}]") );

if($category_top_post == 2){
	$top_atts_2= array( "layout" => "block-carousel-05", "limit_post" => $limit, "tag_list" => urlencode("[{\"tag_slug\":\"" . $terms->slug . "\"}]") );
}
...
$article_atts= array( "layout" => "grid-02", "limit_post" => $limit_post, "offset_post" => $limit, "tag_list" => urlencode("[{\"tag_slug\":\"" . $terms->slug . "\"}]"), "pagination" => "custom");
